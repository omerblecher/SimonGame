...
Plans:
- [x] 04-01-PLAN.md — .gitignore hardening (*.jks, keystore.properties, .env.production) + release keystore generation + backup (META-01, META-02, META-03, SIGN-01, SIGN-03)
- [x] 04-02-PLAN.md — Verify Google Play Developer account + retrieve production AdMob banner unit ID + create GDPR consent form draft (SIGN-05, STORE-02, STORE-03, STORE-05, STORE-06)
- [ ] 04-03-PLAN.md — Python Pillow icon script + mipmap PNGs + adaptive icon XML update + visual verification on device (META-04, STORE-04)
- [x] 04-04-PLAN.md — Privacy policy HTML in docs/ for GitHub Pages (STORE-01)
...
| 4. Signing + Play Store Submission | 3/9 | In Progress|  |
